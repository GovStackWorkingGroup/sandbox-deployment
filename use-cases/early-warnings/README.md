...
helm upgrade --install kafka . -f values.yaml

helm dep build
```

```shell
helm install early-warnings ./use-cases/early-warnings --create-namespace --namespace early-warnings
```

```shell
helm install kafka /use-cases/early-warnings/kafka --create-namespace --namespace early-warnings
```

```shell
helm upgrade --install early-warnings ./use-cases/early-warnings --create-namespace --namespace early-warnings
```
